<section id="home-conteudo" class="sec-conteudo">

    <!-- Tab panes -->
    <div class="">
        <div class="sobre">
            <div class="">
                <img src="images/ceva.png" class="im-conteudo">
            </div>
            <div class="">
                <div class="conteudo">
                    <div class="seta"> 
                        <h1 class="titulo-conteudo" id="sobreCerverjaria">Sobre a Cervejaria</h1>
                    </div>
                    
                    <br>
                    <p class="tex-conteudo">Lorem ipsum dolor sit amet, consLorem ipsum dolor sit amet, consectetur adipiscing elit, 
